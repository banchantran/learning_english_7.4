    ...
    @foreach($data as $item)
        <div class="row root-row">
            <div class="col-10">
                <div class="row">
                    <div class="col-5">
                        <input type="text" class="input-text-source" value="{{$item[1]}}" placeholder="Text source" name="source[]">
                    </div>
                    <div class="col-5">
                        <input type="text" class="input-text-destination" value="{{$item[4]}}" placeholder="Text destination" name="destination[]">
                    </div>
                    <div class="col-2">
                        <input type="text" class="input-text-note" value="{{$item[0]}}" placeholder="Text note" name="note[]">
                    </div>
                </div>
            </div>
            <div class="col-2">
